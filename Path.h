...
private:
	...
	string transform;
public:
	my_path(string name, string transform, vector<char> commands, double* points, int num_points, Color fill_color, double fill_opacity, Color stroke_color, double stroke_width);
	void render(Graphics& graphics) override;
	string getTransform() override { return transform; }
};

my_path::my_path(string name, string transform, vector<char> commands, double* points, int num_points, Color fill_color, double fill_opacity, Color stroke_color, double stroke_width) : commands(commands), points(points), num_points(num_points), fill_color(fill_color), stroke_color(stroke_color), stroke_width(stroke_width), fill_opacity(fill_opacity), SVGElement(name), transform(transform) {}
