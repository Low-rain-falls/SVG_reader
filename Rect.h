...
public:
  ...
  void render(Graphics graphics) override {
    ...
    graphics.FillRectangle(&brush, this->x1, this->y1, this->width,
                           this->height);
